...
public class User implements UserDetails {
    @Id
    @SequenceGenerator(name = "HS_admin_seq_gen", sequenceName = "HS_admin_id_seq", allocationSize = 1)
    @GeneratedValue(generator = "HS_admin_seq_gen", strategy = GenerationType.SEQUENCE)
    private Integer id;
